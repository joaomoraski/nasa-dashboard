...
import { addFavorite, getFavoriteById, getFavoritesByUserId, deleteFavorite, checkFavorite } from '../controllers/favoriteController';
...
router.post('/api/favorites/check', authMiddleware, asyncHandler(checkFavorite));
